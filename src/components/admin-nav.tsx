...
import { Building2, LayoutDashboard, LogOut, Shield, Key, Hash } from "lucide-react";
    ...
    <nav className="border-b border-dust bg-paper/80 backdrop-blur sticky top-0 z-30">
      <div className="max-w-[1200px] mx-auto px-6 py-3 flex items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/change-pin" className="text-smoke hover:text-ink" title="Set/change 4-digit PIN">
            <Hash size={16} />
          </Link>
          <button
